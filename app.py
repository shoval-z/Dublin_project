...
os.system('gdown https://drive.google.com/uc?id=1-wy8LFiWjGSWDSiTgb5xFMB-5-Wzf21H') #attraction&station
os.system('gdown https://drive.google.com/uc?id=1FmhcvzMM3SMSHyhIjPNAZ4W7ia6J9HW4')#lines_and_stations_new
os.system('gdown https://drive.google.com/uc?id=12etNMoMRPxuYUr1OhRJ9C7b0oym34LkV') #stations_to_attractions_new
os.system('gdown https://drive.google.com/uc?id=1SMxGdpGrcmPq1Iit6Yj0kYKu7ona_XDD') #stop_to_stop
os.system('gdown https://drive.google.com/uc?id=19qXuML4z2rbYjO7udHzYiAwuIbEgUrcS') #bus_stops
os.system('gdown https://drive.google.com/uc?id=1gUM04u7dIgI81etuHZb84ignUUm9S8FZ') #attractions
...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        sizer.Add(staticText1, 0, wx.ALL)
        stations = pd.read_csv('bus_stops.csv')
        stations = stations['stop_code'].unique()
        stations = [str(s) for s in stations]
        self.station_to_attraction = pd.read_csv('station_to_attraction_new.csv')
    ...
    def final_output(self):
        ...
        hl.HyperLinkCtrl(self, -1, 'To see the locations on map click here',
                         URL="https://epic-lumiere-c21f13.netlify.app/",
    ...
    def create_map(self):
        ...
        folium.Marker(location=[s2_lat, s2_long],
                      icon=folium.Icon(icon='bus', prefix='fa', color='purple'),
                      tooltip=f'station to {self.second_a}').add_to(
            map_osm)
        folium.Marker(location=[s3_lat, s3_long],
                      icon=folium.Icon(icon='bus', prefix='fa', color='purple'),
                      tooltip=f'station to {self.third_a}').add_to(
            map_osm)
